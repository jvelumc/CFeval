...
```
From this it seems that the naive model performs better than the fancy causal model. These performance measures represent the performance of the models under the given treatment assignment.
...
And similarly, if everybody would have been treated (not printing the assumptions and calibration plots again):
```{r}
CFscore(
  object = list(
    "random" = random_predictions,
